package com.example.demo.deadLock死锁;
 ...
 * td1 睡眠结束后需要锁定 o2 才能执行， 而此时 o2 已被 td2 锁定
 * td2 睡眠结束后需要锁定 o1 才能执行， 而此时 o1 已被 td1 锁定
...
public class DealLock implements Runnable{
    ...
    public static void main(String[] args) {
        DealLock td1 = new DealLock();
        DealLock td2 = new DealLock();
        td1.flag = 1;
        td2.flag = 0;
        // td1，td2都处于可执行状态，单JVM线程调度先执行那个线程是不确定的。
